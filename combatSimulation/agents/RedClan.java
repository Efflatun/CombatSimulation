...
public class RedClan extends SimpleAgent{
	public RedClan (double energy){
	...
	public void step() {
		...
		if (100 * RandomHelper.nextDouble() < rate){
			...
			RedClan redClan = new RedClan(this.getEnergy());    // create a new Clan offspring and assing its energy
			context.add(redClan);	                       // add the offspring to the root context
		}
