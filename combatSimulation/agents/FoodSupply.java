...
public class FoodSupply extends SimpleAgent {
	...
	public FoodSupply(Context context, int x, int y ){
		// Get the grass regrow time from the user parameters
		Parameters p = RunEnvironment.getInstance().getParameters();
		int regrowTime = (Integer)p.getValue("foodsupplyregrowthtime");
		...
		GridValueLayer vl = (GridValueLayer)context.getValueLayer("Food Supply Field");
	...
	private void updateValueLayer(){
		GridValueLayer vl = (GridValueLayer)ContextUtils.getContext(this).getValueLayer("Food Supply Field");
